 ...
 */
package com.ki11erwolf.shoppery.config;

import java.io.File;

/**
 * Holds references to the various configuration
 * files used by Shoppery. As well as handles
...
public class ModConfig {
     ...
     */
    public static final ConfigFile GENERAL_CONFIG = new ConfigFile(newConfig("shoppery"));
